...
### 테마 기반 주식 스크리닝 · 시장 배너 · 증시 캘린더 · 기술 분석 대시보드

[![Live Demo](https://img.shields.io/badge/Live%20Demo-qsscreen.vercel.app-00C853?style=plastic&logo=vercel&logoColor=white)](https://qs-front-psi.vercel.app/)
[![Backend API](https://img.shields.io/badge/API-Render%20FastAPI-46E3B7?style=plastic&logo=render&logoColor=white)](https://quant-backend-e82y.onrender.com/health)
[![Repository](https://img.shields.io/badge/Repo-QuantScreen-181717?style=plastic&logo=github&logoColor=white)](https://github.com/dktpxmdkalshvps/QuantScreen)
...
![Alembic](https://img.shields.io/badge/Alembic-Migration-6C63FF?style=plastic)
![Vercel](https://img.shields.io/badge/Vercel-000000?style=plastic&logo=vercel&logoColor=white)
![Render](https://img.shields.io/badge/Render-46E3B7?style=plastic&logo=render&logoColor=white)
![Python](https://img.shields.io/badge/Python-3.12.7-3776AB?style=plastic&logo=python&logoColor=white)

<br/>

![Gemini](https://img.shields.io/badge/Gemini-4285F4?style=plastic&logo=googlegemini&logoColor=white)
![Gemini Jules](https://img.shields.io/badge/Gemini%20Jules-AI%20Coding-8E75B2?style=plastic&logo=googlegemini&logoColor=white)
![Claude Code](https://img.shields.io/badge/Claude%20Code-D97757?style=plastic&logo=anthropic&logoColor=white)
![Codex](https://img.shields.io/badge/Codex-OpenAI-111111?style=plastic&logo=openai&logoColor=white)
...
| Dashboard | Theme Screening |
|---|---|
| ![Dashboard](docs/assets/screenshots/dashboard.png) | ![Theme Table](docs/assets/screenshots/theme-table.gif) |

| Stock Detail | Market Calendar |
|---|---|
| ![Stock Detail](docs/assets/screenshots/stock-detail.gif) | ![Market Calendar](docs/assets/screenshots/market-calendar.png) |
...
| 이슈 | 원인 | 해결 | 상세 |
|---|---|---|---|
| Render Free DB 생성 실패 | Free PostgreSQL 1개 제한 | 기존 DB 삭제 후 Blueprint 재배포 | [`TROUBLESHOOTING.md`](docs/TROUBLESHOOTING.md#1-render-free-postgresql-생성-실패) |
| `psycopg-binary` 설치 실패 | 고정 버전이 빌드 환경에서 제공되지 않음 | `psycopg[binary]==3.3.4`로 조정 | [`TROUBLESHOOTING.md`](docs/TROUBLESHOOTING.md#2-psycopg-binary-버전-설치-실패) |
| SQLAlchemy 타입 힌트 오류 | Render가 Python 3.14로 빌드 | Python 3.12.7 고정 | [`TROUBLESHOOTING.md`](docs/TROUBLESHOOTING.md#3-python-314--sqlalchemy-타입-힌트-오류) |
| API 404 | 프론트 호출 경로와 백엔드 경로 불일치 | `compat.py`에 호환 API 추가 | [`TROUBLESHOOTING.md`](docs/TROUBLESHOOTING.md#4-api-404-프론트-호출-경로와-백엔드-라우트-불일치) |
| CORS 차단 | 실제 Vercel origin 누락 | `CORS_ORIGINS`에 배포 origin 추가 | [`TROUBLESHOOTING.md`](docs/TROUBLESHOOTING.md#5-cors-차단) |
| 종목 미표시 | 프론트 응답 계약과 백엔드 응답 구조 불일치 | 공통 응답 래퍼 통일 | [`TROUBLESHOOTING.md`](docs/TROUBLESHOOTING.md#6-프론트-응답-계약-불일치) |
| 캘린더 미표시 | 샘플 row만 존재해 UI가 비어 보임 | 캘린더 fallback 데이터 보강 | [`TROUBLESHOOTING.md`](docs/TROUBLESHOOTING.md#7-증시-캘린더-미표시) |
| Render Free Shell 제한 | Free Web Service Shell Access 미지원 | External DB URL 기반 원격 migration/seed | [`TROUBLESHOOTING.md`](docs/TROUBLESHOOTING.md#8-render-free-환경에서-seed와-migration-실행) |
...
- [`docs/PORTFOLIO_SUBMISSION_CHECKLIST.md`](docs/PORTFOLIO_SUBMISSION_CHECKLIST.md)
